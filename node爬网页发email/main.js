const superagent = require('superagent'); // 获取指定网页的DOM
const cheerio = require('cheerio'); // 能想jQuery一样获取DOM节点
const nodemailer = require('nodemailer'); // 发送邮件的node插件
const ejs = require('ejs'); //ejs引擎模板
const fs = require('fs'); //文件读写
const path = require('path'); //路径配置
const schedule = require('node-schedule'); //定时器任务库

//纪念日
let startDay = "2019/3/5";
...
//发送者昵称与邮箱地址
let EmailFrom = '"zlc140" <zlc140@163.com>';

//接收者邮箱地
let EmailTo = "278761071@qq.com";
//邮件主题
...
const oneUrl = "http://wufazhuce.com/"; //ONE 的网站地址
